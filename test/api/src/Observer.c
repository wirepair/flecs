...
void Observer_propagate_match_relationship_w_self_up(void) {
    ...
    Probe ctx = {0};
    ecs_observer(world, {
        .filter.terms = {{ TagB, .src.flags = EcsSelf|EcsUp, .trav = EcsIsA }},
        .events = {EcsOnAdd},
        .callback = Observer,
        .ctx = &ctx
    });
...
void Observer_propagate_match_relationship_w_up(void) {
    ...
    Probe ctx = {0};
    ecs_observer(world, {
        .filter.terms = {{ TagB, .src.flags = EcsUp, .trav = EcsIsA }},
        .events = {EcsOnAdd},
        .callback = Observer,
        .ctx = &ctx
    });
...
void Observer_on_remove_target_from_base_at_offset(void) {
    ...
    ecs_entity_t o = ecs_observer(world, {
        .filter.terms = {
            { .id = ecs_pair(R, EcsWildcard), .src.flags = EcsUp, .trav = EcsIsA },
            { .id = C },
        },
        .events = { EcsOnRemove },
        .callback = Observer,
...
void Observer_on_remove_target_component_from_base_at_offset(void) {
    ...
    ecs_entity_t o = ecs_observer(world, {
        .filter.terms = {
            { .id = ecs_pair(ecs_id(Position), EcsWildcard), .src.flags = EcsUp, .trav = EcsIsA },
            { .id = C },
        },
        .events = { EcsOnRemove },
...
void Observer_wildcard_propagate_w_other_table(void) {
    ...
    ecs_observer(world, {
        .filter.terms = {{ ecs_pair(rel, EcsWildcard), .src.flags = EcsUp }},
        .events = {EcsWildcard},
        .callback = Observer_dummy
    });
...
void Observer_cache_test_1(void) {
    ...
    ecs_observer(world, {
        .filter.terms = {{ tag, .src.flags = EcsUp, .trav = EcsChildOf }},
...
void Observer_cache_test_2(void) {
    ...
    ecs_observer(world, {
        .filter.terms = {{ tag_1, .src.flags = EcsUp, .trav = EcsChildOf }},
        .events = {EcsOnAdd, EcsOnRemove},
        .callback = Observer,
        .ctx = &ctx_1
    });
    ecs_observer(world, {
        .filter.terms = {{ tag_2, .src.flags = EcsUp, .trav = EcsChildOf }},
        .events = {EcsOnAdd, EcsOnRemove},
        .callback = Observer,
        .ctx = &ctx_2
    });
...
void Observer_cache_test_4(void) {
    ...
    ecs_observer(world, {
        .filter.terms = {{ tag_0, .src.flags = EcsUp, .trav = EcsChildOf }},
        .events = {EcsOnAdd, EcsOnRemove},
        .callback = Observer,
        .ctx = ctx_0
    });
...
void Observer_cache_test_9(void) {
    ...
    Probe ctx = {0};
    ecs_observer(world, {
        .filter.terms = {{ ecs_id(Position), .src.flags = EcsUp, .trav = EcsIsA }},
        .events = { EcsOnRemove },
        .callback = Observer,
        .ctx = &ctx
    });
