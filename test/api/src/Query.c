...
void Query_simple_query_existing_table(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "TagA");
    test_assert(q != NULL);
...
void Query_wildcard_query_existing_table(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "(Rel, *)");
    test_assert(q != NULL);
...
void Query_only_optional_new_unset_tables(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "?TagC");
    test_assert(q != NULL);
...
void Query_singleton_w_optional_new_empty_table(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Singleton($), ?TagA");
    test_assert(q != NULL);
...
void Query_singleton_w_optional_new_unset_tables(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Singleton($), ?TagC");
    test_assert(q != NULL);
...
void Query_query_only_from_entity(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(e)");
    test_assert(q != NULL);
...
void Query_query_only_from_entity_no_match_iter_alloc(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "A(e), B(e), C(e), D(e), E(e)");
    test_assert(q != NULL);
...
void Query_query_only_from_singleton(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag($)");
    test_assert(q != NULL);
...
void Query_query_only_from_entity_optional(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "?Position(Ent)");
    test_assert(q != NULL);
...
void Query_query_only_from_entity_or(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(Ent) || Velocity(Ent)");
    test_assert(q != NULL);
...
void Query_query_from_entity_or_change(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(Ent) || Velocity(Ent), Tag");
    test_assert(q != NULL);
...
void Query_query_w_singleton_tag_non_instanced(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position, Singleton($)");
    ecs_iter_t it = ecs_query_cache_iter(world, q);
...
void Query_query_w_singleton_tag_instanced(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_init(world, &(ecs_query_desc_t){ .filter = {
...
void Query_query_w_from_entity(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "TagA, TagB(e)");
    test_assert(q != NULL);
...
void Query_query_w_from_singleton(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "TagA, TagB($)");
    test_assert(q != NULL);
...
void Query_query_w_existing_switch_and_case(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "(Movement, *)");
    test_assert(q != NULL);
...
void Query_query_for_case_existing(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "(Movement, Walking)");
    test_assert(q != NULL);
...
void Query_query_for_switch_filter_term(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "[none] (Movement, *)");
    test_assert(q != NULL);
...
void Query_query_changed_after_new(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "[in] Position");
    test_assert(q != NULL);
    test_assert(ecs_query_cache_changed(q, 0) == true);
    test_assert(ecs_query_cache_changed(q, 0) == true);

    ecs_iter_t it = ecs_query_cache_iter(world, q);
    test_assert(ecs_query_cache_changed(q, 0) == true);
    while (ecs_query_cache_next(&it)) { }
    test_assert(ecs_query_cache_changed(q, 0) == false);
...
void Query_query_change_after_modified_out_term(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "[in] Position, [out] Velocity");
    test_assert(q != NULL);
    test_assert(ecs_query_cache_changed(q, 0) == true);
    test_assert(ecs_query_cache_changed(q, 0) == true);
...
void Query_query_change_check_iter(void) {
    ...
    test_assert(ecs_query_cache_changed(q, 0) == true);
    while (ecs_query_cache_next(&it)) { 
        test_bool(ecs_query_cache_changed(q, &it), true);
    }
    test_assert(ecs_query_cache_changed(q, 0) == false);
    ...
    test_bool(ecs_query_cache_changed(q, &it), false);

    test_bool(ecs_query_cache_next(&it), true);
    test_int(it.count, 1);
    test_int(it.entities[0], e3);
    test_bool(ecs_query_cache_changed(q, &it), false);
    test_bool(ecs_query_cache_changed(q, NULL), false);
    test_bool(ecs_query_cache_next(&it), false);
...
void Query_query_change_check_iter_after_skip_read(void) {
    ...
    it = ecs_query_cache_iter(world, q);
    test_bool(ecs_query_cache_next(&it), true);
    test_assert(ecs_query_cache_changed(q, &it) == true);
...
void Query_query_change_check_iter_after_skip_write(void) {
    ...
    ecs_query_cache_t *qw = ecs_query_cache_new(world, "[out] Position");
    ...
    it = ecs_query_cache_iter(world, qw);
    test_assert(ecs_query_cache_changed(q, 0) == false);
    test_bool(ecs_query_cache_next(&it), true);
    test_assert(ecs_query_cache_changed(q, 0) == false);
    ecs_query_cache_skip(&it);
...
void Query_query_change_parent_term(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "[in] Position(up)");
    test_assert(q != NULL);
    test_assert(ecs_query_cache_changed(q, 0) == true);
    test_assert(ecs_query_cache_changed(q, 0) == true);
...
void Query_query_change_prefab_term(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "[in] Position(up(IsA))");
    test_assert(q != NULL);
    test_assert(ecs_query_cache_changed(q, 0) == true);
    test_assert(ecs_query_cache_changed(q, 0) == true);
...
void Query_query_change_parent_term_w_tag(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "[in] Position(up), ?Prefab");
    test_assert(q != NULL);
    test_assert(ecs_query_cache_changed(q, 0) == true);
    test_assert(ecs_query_cache_changed(q, 0) == true);
...
void Query_query_change_skip_non_instanced(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(up(IsA)), [out] Velocity");
    test_assert(q != NULL);

    ecs_query_cache_t *q_r = ecs_query_cache_new(world, "Position(up(IsA)), [in] Velocity");
    test_assert(q_r != NULL);

    test_assert(ecs_query_cache_changed(q_r, 0) == true);
    ecs_iter_t it = ecs_query_cache_iter(world, q_r);
    while (ecs_query_cache_next(&it)) { }
    test_assert(ecs_query_cache_changed(q_r, 0) == false);
    ...
    while (ecs_query_cache_next(&it)) {
        ...
        if (it.entities[0] == e1) {
            ecs_query_cache_skip(&it); /* Skip one entity in table 1 */
        }
        if (it.entities[0] == e3 || it.entities[0] == e4) {
            ecs_query_cache_skip(&it); /* Skip both entities in table 1 */
        }
    ...
    test_bool(ecs_query_cache_changed(q_r, NULL), true);
    
    it = ecs_query_cache_iter(world, q_r);
    count = 0;
    ...
    while (ecs_query_cache_next(&it)) {
        ...
        if (it.entities[0] == e1 || it.entities[0] == e2) {
            ...
            test_bool( ecs_query_cache_changed(0, &it), true );
        }
        if (it.entities[0] == e3 || it.entities[0] == e4) {
            /* Table did not change, all entities were skipped */
            test_bool( ecs_query_cache_changed(0, &it), false );
        }
    ...
    test_bool(ecs_query_cache_changed(q_r, NULL), false);
...
void Query_query_changed_w_or(void) {
    ...
    test_bool(true, ecs_query_cache_changed(q, NULL));

    ecs_iter_t it = ecs_query_cache_iter(world, q);
    test_bool(true, ecs_query_cache_next(&it));
    test_bool(false, ecs_query_cache_next(&it));
    test_bool(false, ecs_query_cache_changed(q, NULL));
...
void Query_query_changed_w_singleton(void) {
    ...
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    test_bool(true, ecs_query_cache_next(&it));
    test_bool(true, ecs_query_cache_changed(NULL, &it));
    test_uint(e, it.entities[0]);
    Position *p = ecs_field(&it, Position, 1);
    Velocity *v = ecs_field(&it, Velocity, 2);
    test_int(p->x, 10);
...
void Query_query_changed_w_only_singleton(void) {
...

    {
        ecs_iter_t it = ecs_query_cache_iter(world, q);
        test_bool(true, ecs_query_cache_next(&it));
        test_bool(false, ecs_query_cache_changed(NULL, &it));
        test_int(0, it.count);
        Position *p = ecs_field(&it, Position, 1);
        test_int(p->x, 1);
        test_int(p->y, 2);
...
void Query_subquery_match_existing(void) {
    ...
    ecs_query_cache_t *sq = ecs_query_cache_init(world, &(ecs_query_desc_t){
    ...
    it = ecs_query_cache_iter(world, sq);
    while (ecs_query_cache_next(&it)) {
        table_count ++;
        entity_count += it.count;
...
void Query_subquery_unmatch(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position, Position(up)");
    test_assert(q != NULL);
...
void Query_query_single_pairs(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "(Rel, Velocity)");
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    while (ecs_query_cache_next(&it)) {
        table_count ++;
...
void Query_query_single_instanceof(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "(IsA, BaseA)");
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    while (ecs_query_cache_next(&it)) {
        table_count ++;
...
void Query_query_single_childof(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "(ChildOf, BaseA)");
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    while (ecs_query_cache_next(&it)) {
        table_count ++;
...
void Query_query_optional_owned(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position, ?Velocity(self)");
    test_assert(q != NULL);
...
void Query_query_optional_any(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position, ?Velocity(self|up(IsA))");
    test_assert(q != NULL);
...
void Query_get_shared_tag(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(up(IsA))");
...
void Query_orphaned_query(void) {
    ...
    test_assert(!ecs_query_cache_orphaned(sq));
...
void Query_nested_orphaned_query(void) {
    ...
    ecs_query_cache_t *nsq = ecs_query_cache_init(world, &(ecs_query_desc_t){
        .filter.expr = "Position",
        .parent = sq
    });
    ...
    test_assert(!ecs_query_cache_orphaned(sq));
    test_assert(!ecs_query_cache_orphaned(nsq));
...
void Query_stresstest_query_free(void) {
    ...
    for (int i = 0; i < 10000; i ++) {
        ecs_query_cache_t *q = ecs_query_cache_new(world, "Foo");
         ecs_query_cache_fini(q);
    }
...
void Query_only_from_singleton(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "e($)");
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    test_assert(!ecs_query_cache_next(&it));
...
void Query_group_by_iter_one(void) {
    ...
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    ecs_query_cache_set_group(&it, TgtB);
...
void Query_group_by_iter_one_all_groups(void) {
    ...
    it = ecs_query_cache_iter(world, q);
    ecs_query_cache_set_group(&it, TgtA);
    ...
    it = ecs_query_cache_iter(world, q);
    ecs_query_cache_set_group(&it, TgtC);
...
void Query_group_by_iter_one_empty(void) {
    ...
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    ecs_query_cache_set_group(&it, TgtD);
    test_bool(false, ecs_query_cache_next(&it));
...
void Query_group_by_w_deleted_group_id(void) {
    ...
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    ecs_query_cache_set_group(&it, tgt);
    test_bool(true, ecs_query_cache_next(&it));
    test_int(1, it.count);
    test_uint(e, it.entities[0]);
    test_bool(false, ecs_query_cache_next(&it));
...
void Query_group_by_callbacks(void) {
    ...
    const ecs_query_cache_group_info_t *gi = ecs_query_cache_get_group_info(q, it.group_id);
    test_assert(gi != NULL);
    ...
    gi = ecs_query_cache_get_group_info(q, it.group_id);
    test_assert(gi != NULL);
    test_assert(gi->ctx != NULL);
...
void Query_group_table_count(void) {
    ...
    const ecs_query_cache_group_info_t *gi_a;
    const ecs_query_cache_group_info_t *gi_b;
    gi_a = ecs_query_cache_get_group_info(q, TgtA);
    gi_b = ecs_query_cache_get_group_info(q, TgtB);
...
void Query_query_optional_shared_tag(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "TagA, ?TagB(self|up(IsA))");
    test_assert(q != NULL);
...
void Query_isa_self_superset(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(self|up(IsA))");
    test_assert(q != NULL);
...
void Query_childof_superset(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(up)");
    test_assert(q != NULL);
...
void Query_superset_2_targets(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(up(R))");
...
void Query_existing_isa_cascade(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(cascade(IsA))");
    test_assert(q != NULL);
...
void Query_childof_cascade(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(cascade)");
    test_assert(q != NULL);
...
void Query_existing_custom_rel_cascade(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(cascade(Rel))");
    test_assert(q != NULL);
...
void Query_cascade_w_2_depths_desc(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag(cascade|desc(Rel))");
    test_assert(q != NULL);
...
void Query_not_pair_relation_wildcard(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Foo, !(*, ObjA)");
    test_assert(q != NULL);
...
void Query_not_pair_object_wildcard(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Foo, !(RelA, *)");
    test_assert(q != NULL);
...
void Query_two_pair_wildcards_one_not(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Foo, (RelA, *), !(RelB, *)");
    test_assert(q != NULL);
...
void Query_two_pair_wildcards_one_not_any(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Foo, (RelA, *), !(RelB, _)");
    test_assert(q != NULL);
...
void Query_cascade_rematch_2_lvls(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(cascade)");
    test_assert(q != NULL);
...
void Query_cascade_rematch_2_lvls_2_relations(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(cascade(R))");
...
void Query_cascade_topological(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag, ?Tag(cascade(R))");
    test_assert(q != NULL);
...
void Query_cascade_desc_rematch_2_lvls(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(cascade|desc)");
    test_assert(q != NULL);
...
void Query_cascade_desc_rematch_2_lvls_2_relations(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Position(cascade|desc(R))");
...
void Query_cascade_desc_topological(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag, ?Tag(cascade|desc(R))");
    test_assert(q != NULL);
...
void Query_rematch_optional_ref_w_2_refs(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Tag, Velocity(up), ?Position(up)");
    test_assert(q != NULL);
...
void Query_rematch_optional_ref_tag_w_ref_component(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "TagA, ?Position(up), TagB(up)");
    test_assert(q != NULL);
...
void Query_match_query_expr_from_scope(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "Bar");
    test_assert(q != NULL);
...
void Query_query_long_or_w_ref(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, 
...
void Query_0_query(void) {
    ...
    ecs_query_cache_t *q = ecs_query_cache_new(world, "0");
    test_assert(q != NULL);
...
void Query_table_count(void) {
    ...
    test_int(0, ecs_query_cache_table_count(q));

    ecs_new(world, TagA);

    test_int(1, ecs_query_cache_table_count(q));
    ...
    test_int(2, ecs_query_cache_table_count(q));
...
void Query_empty_table_count(void) {
    ...
    test_int(0, ecs_query_cache_empty_table_count(q));
    ...
    test_int(1, ecs_query_cache_empty_table_count(q));
...
void Query_entity_count(void) {
    ...
    test_int(0, ecs_query_cache_entity_count(q));

    ecs_entity_t e1 = ecs_new(world, TagA);

    test_int(1, ecs_query_cache_entity_count(q));

    ecs_entity_t e2 = ecs_new(world, TagA);

    test_int(2, ecs_query_cache_entity_count(q));
...
void Query_query_next_table(void) {
    ...
    ecs_iter_t it = ecs_query_cache_iter(world, q);
    test_bool(true, ecs_query_cache_next_table(&it));
    test_int(0, it.count);
    ...
    test_bool(false, ecs_query_cache_next_table(&it));
...
void Query_query_next_table_w_populate(void) {
    ...
    test_int(0, it.count);
    test_assert(it.table == ecs_get_table(world, e1));
    ecs_query_cache_populate(&it, false);
    test_int(1, it.count);
    test_assert(it.table == ecs_get_table(world, e1));
    test_uint(it.entities[0], e1);
...
void Query_query_next_table_w_changed(void) {
    ...
    ecs_query_cache_t *qr = ecs_query(world, {
        .filter.terms = {{
            .id = ecs_id(Position),
            .inout = EcsIn
        }}
    ...
    test_bool(true, ecs_query_cache_changed(qr, NULL));
    ecs_iter_t it = ecs_query_cache_iter(world, qr);
    while (ecs_query_cache_next_table(&it)) { }
    test_bool(false, ecs_query_cache_changed(qr, NULL));
    ...
    it = ecs_query_cache_iter(world, qr);
    test_bool(true, ecs_query_cache_next_table(&it));
    test_bool(false, ecs_query_cache_changed(NULL, &it));
    test_bool(true, ecs_query_cache_next_table(&it));
    test_bool(false, ecs_query_cache_changed(NULL, &it));
...
void Query_create_query_existing_query_entity(void) {
    ...
    ecs_query_cache_t *q_1 = ecs_query_cache_init(world, &(ecs_query_desc_t){
    ...
    ecs_query_cache_t *q_2 = ecs_query_cache_init(world, &(ecs_query_desc_t){
        .filter.entity = ecs_entity(world, { .name = "q" }),
        .filter.terms = {
            { .id = Foo },
            { .id = Bar }
...
void Query_query_w_singleton_w_rule_iter(void) {
    ...
    ecs_iter_t qit = ecs_query_cache_iter(ecs, q);
    test_bool(true, ecs_query_cache_next(&qit));
    ...
    test_bool(false, ecs_query_cache_next(&qit));
...
void Query_query_w_singleton_nested_iter(void) {
    ...
    ecs_query_cache_t *qa = ecs_query(ecs, {
        .filter.terms = {
            {TagA}, {Singleton, .src.id = Singleton}
        }
    });

    ecs_query_cache_t *qb = ecs_query(ecs, {
        .filter.terms = {
    ...
    ecs_iter_t qita = ecs_query_cache_iter(ecs, qa);
    ecs_iter_t qitb = ecs_query_cache_iter(ecs, qb);

    test_bool(ecs_query_cache_next(&qita), true);
    test_int(1, qita.count);
    test_uint(ea, qita.entities[0]);

    test_bool(ecs_query_cache_next(&qitb), true);
    ...
    test_bool(ecs_query_cache_next(&qita), false);
    test_bool(ecs_query_cache_next(&qitb), false);
...
void Query_query_w_singleton_interleaved_iter(void) {
    ...
    ecs_query_cache_t *qc = ecs_query(ecs, {
        .filter.terms = {
    ...
    ecs_iter_t qitc = ecs_query_cache_iter(ecs, qc);
    test_bool(ecs_query_cache_next(&qitc), true);
    ...
    test_bool(ecs_query_cache_next(&qitb), false);
    test_bool(ecs_query_cache_next(&qitc), false);
...
void Query_set_get_context(void) {
    ...
    test_assert(ecs_query_cache_get_ctx(q) == &ctx);
    test_assert(ecs_query_cache_get_binding_ctx(q) == NULL);
...
void Query_set_get_binding_context(void) {
    ...
    test_assert(ecs_query_cache_get_binding_ctx(q) == &ctx);
    test_assert(ecs_query_cache_get_ctx(q) == NULL);
